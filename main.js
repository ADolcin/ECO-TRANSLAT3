  ...
  function onUserSignedIn(user) {
    ...
    // Populate profile card inside acc panel
    const panelAvatar = document.getElementById('accPanelAvatar');
    const panelName   = document.getElementById('accPanelName');
    const panelEmail  = document.getElementById('accPanelEmail');
    if(panelAvatar && user.photoURL) panelAvatar.src = user.photoURL;
    if(panelName)  panelName.textContent  = user.displayName || 'Usuario';
...
// Exponer funciones globalmente para que onclick las encuentre siempre
